      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-950 via-purple-900 to-purple-950 text-white p-6">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-purple-600/20 to-purple-700/10 border border-purple-500/50 backdrop-blur rounded-2xl p-8 text-center shadow-2xl shadow-purple-500/10">
            ...
            <p className="mt-6 text-xs text-purple-400">Check browser console (F12) for detailed error information</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-950 via-purple-900 to-purple-950 text-white">
      ...
      <header className="bg-gradient-to-r from-purple-900/80 via-purple-800/60 to-purple-900/80 backdrop-blur-xl border-b border-purple-700/50 p-4 sm:p-6 shadow-2xl">
        {/* Top Bar - User Info and Actions - Mobile Responsive */}
        ...
        {/* Global Link Settings Section - Mobile responsive */}
        <div className="mb-6">
          <div className="bg-gradient-to-br from-purple-900/50 via-purple-800/40 to-indigo-900/50 border border-purple-600/50 rounded-xl p-4 backdrop-blur shadow-lg">
            ...
            {/* Link toggle grid - Mobile responsive */}
                    ...
                    <div className="mt-2 h-2 rounded-full overflow-hidden bg-gray-800">
                      <div 
                        className={`h-full transition-all duration-500 ${
                          isActive ? `bg-gradient-to-r ${linkColor.replace('from-', 'from-').replace('to-', 'to-')}` : 'bg-gray-600'
                        }`}
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2 sm:gap-4">
          {/* Total Content Card */}
          <div className={`${analyticsColors[0].bg} border ${analyticsColors[0].border} rounded-xl p-3 sm:p-4 backdrop-blur shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all duration-300 relative overflow-hidden group`}>
            <div className="relative z-10">
              ...
              <p className={`text-2xl sm:text-3xl font-bold ${analyticsColors[0].text} mb-2`}>
                {analytics.totalAnimes + analytics.totalMovies + analytics.totalManga}
              </p>
              <div className="text-xs text-gray-400 font-medium">Anime • Movies • Manga</div>
            </div>
          ...
          {/* Anime Card */}
          <div className={`${analyticsColors[1].bg} border ${analyticsColors[1].border} rounded-xl p-3 sm:p-4 backdrop-blur shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all duration-300 relative overflow-hidden group`}>
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-3">
              ...
              <p className={`text-2xl sm:text-3xl font-bold ${analyticsColors[1].text} mb-2`}>{analytics.totalAnimes}</p>
              <div className="text-xs text-gray-400 font-medium">Series Collection</div>
            </div>
          ...
          {/* Movies Card */}
          <div className={`${analyticsColors[2].bg} border ${analyticsColors[2].border} rounded-xl p-3 sm:p-4 backdrop-blur shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all duration-300 relative overflow-hidden group`}>
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-3">
              ...
              <p className={`text-2xl sm:text-3xl font-bold ${analyticsColors[2].text} mb-2`}>{analytics.totalMovies}</p>
              <div className="text-xs text-gray-400 font-medium">Movie Collection</div>
            </div>
          ...
          {/* Manga Card */}
          <div className={`${analyticsColors[3].bg} border ${analyticsColors[3].border} rounded-xl p-3 sm:p-4 backdrop-blur shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all duration-300 relative overflow-hidden group`}>
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-3">
              ...
              <p className={`text-2xl sm:text-3xl font-bold ${analyticsColors[3].text} mb-2`}>{analytics.totalManga}</p>
              <div className="text-xs text-gray-400 font-medium">Comic Collection</div>
            </div>
          ...
          {/* Episodes Card */}
          <div className={`${analyticsColors[4].bg} border ${analyticsColors[4].border} rounded-xl p-3 sm:p-4 backdrop-blur shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all duration-300 relative overflow-hidden group`}>
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-3">
              ...
              <p className={`text-2xl sm:text-3xl font-bold ${analyticsColors[4].text} mb-2`}>{analytics.totalEpisodes}</p>
              <div className="text-xs text-gray-400 font-medium">Total Episodes</div>
            </div>
          ...
          {/* Download Pages Card */}
          <div className={`${analyticsColors[5].bg} border ${analyticsColors[5].border} rounded-xl p-3 sm:p-4 backdrop-blur shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all duration-300 relative overflow-hidden group`}>
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-3">
              ...
              <p className={`text-2xl sm:text-3xl font-bold ${analyticsColors[5].text} mb-2`}>{downloadStats.totalPages}</p>
              <div className="text-xs text-gray-400 font-medium">Total Pages • {downloadStats.totalDownloadEpisodes} Episodes</div>
            </div>
