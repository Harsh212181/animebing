  ...
  return (
    <>
      <SEO
        ...
        description="Read AnimeBing's terms and conditions. By using our website you agree to our rules regarding streaming, content usage, copyright, and user responsibilities."
        keywords="terms and conditions, animebing terms, user agreement, copyright, DMCA"
        canonicalUrl="https://animebing.in/terms"
      />
