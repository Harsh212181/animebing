...
const SubAdminLogin: React.FC<SubAdminLoginProps> = ({ onLogin }) => {
  ...
  return (
    <div className="min-h-screen bg-[#0b1120] relative overflow-hidden flex items-center justify-center p-3 sm:p-4">
      ...
      <div className="w-full max-w-md relative z-10">
        {/* Header with decorative elements — compact on mobile */}
        <div className="text-center mb-4 sm:mb-6">
          <div className="relative inline-flex items-center justify-center">
            <div className="absolute w-12 h-12 sm:w-16 sm:h-16 rounded-2xl bg-cyan-500/20 animate-ping-slow" />
            <div className="relative w-12 h-12 sm:w-16 sm:h-16 rounded-2xl bg-gradient-to-br from-cyan-400 to-blue-600 flex items-center justify-center shadow-lg shadow-cyan-500/30">
          ...
          <div className="flex items-center justify-center gap-2 mt-1.5 sm:mt-2">
            ...
            <p className="text-slate-400 text-xs sm:text-sm">AnimaBing Management Panel</p>
            <div className="h-px w-6 sm:w-8 bg-gradient-to-l from-transparent to-cyan-500/50" />
          </div>
        </div>

        {/* Glassmorphism card — tighter on mobile */}
        <form onSubmit={handleSubmit} className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 space-y-3.5 sm:space-y-5 shadow-2xl shadow-black/20">
          {/* Username field */}
          <div>
            <label className="block text-xs sm:text-sm font-medium text-slate-300 mb-1 sm:mb-1.5">Username</label>
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                <svg className="w-4 h-4 sm:w-5 sm:h-5 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.5">
              ...
              <input
                ...
                className="w-full bg-white/5 border border-white/10 text-white rounded-xl pl-10 pr-4 py-2.5 sm:py-3 text-sm placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-cyan-400/70 focus:border-cyan-400/50 transition-all"
          ...
          {/* Password field */}
          <div>
            <label className="block text-xs sm:text-sm font-medium text-slate-300 mb-1 sm:mb-1.5">Password</label>
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                <svg className="w-4 h-4 sm:w-5 sm:h-5 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.5">
              ...
              <input
                ...
                className="w-full bg-white/5 border border-white/10 text-white rounded-xl pl-10 pr-12 py-2.5 sm:py-3 text-sm placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-cyan-400/70 focus:border-cyan-400/50 transition-all"
          ...
          {/* Secure badge — hidden on very small phones */}
          <div className="hidden xs:flex sm:flex items-center gap-2 text-xs text-slate-500">
          ...
          {/* Error message */}
          {error && (
            <div className="bg-red-900/30 border border-red-700/50 text-red-300 text-xs sm:text-sm rounded-xl px-3 sm:px-4 py-2.5 sm:py-3 flex items-center gap-2">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 disabled:opacity-50 text-white font-semibold py-2.5 sm:py-3 rounded-xl transition-all flex items-center justify-center gap-2 shadow-lg shadow-cyan-600/25 group text-sm sm:text-base"
          >
            {loading ? (
              <>
              ...
              <>
                Login
                <svg className="w-4 h-4 sm:w-5 sm:h-5 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.5">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 bg-white/10 hover:bg-white/15 border border-white/10 text-white font-medium py-2.5 rounded-xl transition-all text-sm sm:text-base"
          >
          ...
          {/* Admin contact hint */}
          <p className="text-center text-slate-500 text-[11px] sm:text-xs pt-0.5">
