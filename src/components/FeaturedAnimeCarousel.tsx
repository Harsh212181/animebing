// src/components/FeaturedAnimeCarousel.tsx – Presentational (data via props)
...
interface Props {
  sectionData: { banner: Anime[]; anime: Anime[]; manga: Anime[]; movie: Anime[] };
...
const FeaturedAnimeCarousel: React.FC<Props> = ({ sectionData, visibility, onAnimeSelect }) => {
