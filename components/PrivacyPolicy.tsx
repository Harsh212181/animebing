  ...
  return (
    <>
      <SEO
        ...
        description="Read AnimeBing's privacy policy. Learn how we collect, use, and protect your personal data while you watch anime online. Covers cookies, GDPR, CCPA, and children's privacy."
        keywords="privacy policy, animebing privacy, data protection, GDPR, CCPA, cookies"
        canonicalUrl="https://animebing.in/privacy"
      />
